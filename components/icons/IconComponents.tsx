...
export const WandSparklesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m22 2-7 20-4-9-9-4Z" /><path d="M13 22 22 13" /><path d="m6 6 3 3" /><path d="m3 3 3 3" />
  </svg>
);
...
export const DotsHorizontalIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
export const MicVocal: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
